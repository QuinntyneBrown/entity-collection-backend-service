...
using System;
using EntityCollectionBackendService.App_Start;
...
using EntityCollectionBackendService.Authentication;
using EntityCollectionBackendService.Filters;
...
namespace EntityCollectionBackendService
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "EntityCollectionBackendService"))
                .EnableSwaggerUi();
